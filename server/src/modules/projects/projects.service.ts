...
addReputation(
...

  {
    ...
    createNotification({
      ...
      message:
        status === "ACCEPTED"
          ? `Your request to join "${request.project.title}" was accepted`
          : `Your request to join "${request.project.title}" was rejected`,
    }).catch((error) => {
      console.error(
        "Notification Error:",
        error
...
export const inviteUserToProject =  async (
    ...
    createNotification({
      ...
      message:
        `You were invited to join ${invite.project.title}`,
    }).catch(console.error);
...
addReputation(
  ...
  createNotification({
    ...
    message:
      status === "ACCEPTED"
        ? `${invite.project.title} invite was accepted`
        : `${invite.project.title} invite was rejected`,
  }).catch((error) => {
    console.error(
      "Notification Error:",
      error
