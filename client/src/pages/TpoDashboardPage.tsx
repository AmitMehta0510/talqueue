...
type Tab = "overview" | "students" | "placements" | "alumni" | "activity";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8 animate-fade-in">
      ...
      <div className="flex border-b border-gray-250 dark:border-gray-800 overflow-x-auto space-x-8 scrollbar-hide">
        {(["overview", "students", "placements", "alumni", "activity"] as Tab[]).map((tab) => (
          <button
            key={tab}
          ...
          >
            {tab === "placements" ? "Placement Drives" : tab === "alumni" ? "Alumni Verification" : tab === "activity" ? "Company Activity" : tab}
          </button>
        ))}
      </div>
              ...
              {recruitersQuery.isLoading ? (
                ...
                <div className="space-y-4">
                  {recruitersQuery.data.map((recruiter) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 bg-gray-50 dark:bg-gray-950 border border-gray-150 dark:border-gray-850 rounded-xl overflow-hidden flex items-center justify-center shrink-0">
                          {recruiter.company?.logoUrl ? (
                            <img src={recruiter.company.logoUrl} alt="" className="h-full w-full object-contain" />
                          ) : (
                            <Building2 className="h-5 w-5 text-gray-405" />
                          )}
                        </div>
                        <div>
                      ...
                      <span className="px-2 py-0.5 bg-gray-50 dark:bg-gray-950 border border-gray-150 dark:border-gray-850 text-gray-500 text-xs font-semibold rounded-full">
